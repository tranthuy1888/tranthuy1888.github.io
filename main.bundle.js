...
module.exports = "<div style=\"width: 300px; margin: 10px;\">\n  <input class=\"form-control\" placeholder=\"Enter key word\" [(ngModel)]=\"txtMessage\" (keyup.enter)=\"SendMessage();\">\n</div>\n<div *ngFor=\"let message of messages\">\n  <p class=\"text-info\">{{ message }}</p>\n</div>\n"
...
var ChatComponent = (function () {
    function ChatComponent() {
        ...
        this.socket = __WEBPACK_IMPORTED_MODULE_1_socket_io_client___default()('https://testchat1003.herokuapp.com/'); //http://localhost:3000
    }
